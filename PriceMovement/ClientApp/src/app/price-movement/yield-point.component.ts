...
@Component({
  selector: 'app-yield-points',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './yield-point.component.html',
  styleUrls: ['./price-movement.component.css']
})
export class YieldPointComponent implements OnInit, OnDestroy {
  public filter: CompositeFilterDescriptor;
  public gridData: YieldPointRecord[];
  ...
  public ngOnInit(): void {
    ...
    this.title = 'Yield Point Movement';
  ...
  public getPriceMovements(): void {
    ...
    this.service.getYieldPointMovement().subscribe(
        result => {
